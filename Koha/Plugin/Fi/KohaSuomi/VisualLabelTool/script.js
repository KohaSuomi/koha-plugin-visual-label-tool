...
$(document).ready(function () {
  $("#holdings_panel .itemselection_action_modify, #otherholdings_panel .itemselection_action_modify").after(` <a href="#" class="itemselection_action_print" onclick="addItemsToPrintQueue(event, $(this))"><i class="fa fa-print"></i>${lt("add_selected_to_queue")}</a>`);
});
